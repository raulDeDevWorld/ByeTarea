...
setUserSuccess('RequireCodeActivation')
  ...
  <nav class="fixed top-0 w-screen bg-white border-gray-200 z-10 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
      <a href="https://flowbite.com" class="flex items-center">
        <img src="/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ByeTarea</span>
      </a>
  ...
  <h1 class="mb-4 text-4xl text-center font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl pt-12 dark:text-white">ByeTarea</h1>
  <p class="mb-8 text-lg text-center font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Asegura tus calificaciones, nosotros te ayudamos.</p>
  ...
  <div class="flex flex-wrap justify-center">
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Matemáticas</button>
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Química</button>
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Física</button>
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Lenguaje</button>
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Ingles</button>
    <button type="button" class="w-[130px] text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Otros</button>
  </div>
  ...
  <p class="text-sm text-center font-medium text-gray-500 dark:text-gray-400">1,715 clienes satisfechos de 1,745 clientes</p>
  <div class="flex items-center justify-center mt-4">
    <span class="w-[100px] text-sm font-medium text-blue-600 dark:text-blue-500">Matemáticas</span>
    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
      <div class="h-5 bg-yellow-400 rounded" style="width: 90%"></div>
    </div>
    <span class="text-sm font-medium text-blue-600 dark:text-blue-500">70%</span>
  </div>
  <div class="flex items-center justify-center mt-4">
    <span class="w-[100px] text-sm font-medium text-blue-600 dark:text-blue-500">Química</span>
    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
      <div class="h-5 bg-yellow-400 rounded" style="width: 95%"></div>
    </div>
    <span class="text-sm font-medium text-blue-600 dark:text-blue-500">17%</span>
  </div>
  <div class="flex items-center justify-center mt-4">
    <span class="w-[100px] text-sm font-medium text-blue-600 dark:text-blue-500">Física</span>
    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
      <div class="h-5 bg-yellow-400 rounded" style="width: 88%"></div>
    </div>
    <span class="text-sm font-medium text-blue-600 dark:text-blue-500">8%</span>
  </div>
  <div class="flex items-center justify-center mt-4">
    <span class="w-[100px] text-sm font-medium text-blue-600 dark:text-blue-500">Lenguaje</span>
    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
      <div class="h-5 bg-yellow-400 rounded" style="width: 93%"></div>
    </div>
    <span class="text-sm font-medium text-blue-600 dark:text-blue-500">4%</span>
  </div>
  <div class="flex items-center justify-center mt-4">
    <span class="w-[100px] text-sm font-medium text-blue-600 dark:text-blue-500">Ingles</span>
    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
      <div class="h-5 bg-yellow-400 rounded" style="width: 88%"></div>
    </div>
  ...
  <p class="text-sm text-center font-medium text-gray-500 dark:text-gray-400">Siempre tenemos profesores disponibles</p>

  <ul role="list" class="max-w-sm divide-y divide-gray-200 dark:divide-gray-700 m-0 p-0">
  ...
  <footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      ...
      <span class="block text-sm text-center text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
    </div>
  </footer>
